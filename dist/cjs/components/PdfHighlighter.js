...
const selection_range_utils_1 = require("../lib/selection-range-utils");
...
class PdfHighlighter extends react_1.PureComponent {
    constructor(props) {
        ...
        this.onPageChange = () => this.props.getCurrentPage(this.viewer.currentPageNumber);
        this.onSelectionChange = () => {
            ...
            if (selection) {
                ...
                if (focusNode &&
                    ...
                    focusNode.className === "Highlight__part") {
        ...
        this.afterSelection = () => {
            ...
            const content = {
                text: (0, selection_range_utils_1.addMissingSpacesToSelection)(range) || range.toString(),
            };
    ...
    findOrCreateHighlightLayer(page) {
        ...
        return (0, pdfjs_dom_1.findOrCreateContainerLayer)(textLayer.div, "PdfHighlighter__highlight-layer");
    }
    goToPage(page) {
    ...
    renderHighlights(nextProps) {
        ...
        for (let pageNumber = 1; pageNumber <= pdfDocument.numPages; pageNumber++) {
            ...
            if (!this.highlightLayerRoots[pageNumber]) {
                this.highlightLayerRoots[pageNumber] = (0, client_1.createRoot)(highlightLayer);
            }
            this.highlightLayerRoots[pageNumber].render(react_1.default.createElement("div", null, (highlightsByPage[String(pageNumber)] || []).map((_a, index) => {
    ...
    containsWhitespaceElements(node) {
    ...
    render() {
        ...
        return (react_1.default.createElement("div", { onPointerDown: this.onMouseDown },
            react_1.default.createElement("div", { ref: this.attachRef, className: "PdfHighlighter", onContextMenu: (e) => e.preventDefault(), style: this.props.style },
