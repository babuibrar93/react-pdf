...
class PdfLoader extends react_1.Component {
    ...
    load() {
        ...
        Promise.resolve()
            ...
            if (!url && !data)
                return;
            return (0, pdfjs_dist_1.getDocument)(Object.assign({ url: url !== null && url !== void 0 ? url : undefined, data: data !== null && data !== void 0 ? data : undefined, ownerDocument }, otherProps)).promise.then((pdfDocument) => {
