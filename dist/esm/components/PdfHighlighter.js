...
class PdfHighlighter extends PureComponent {
    ...
    renderHighlights(nextProps) {
        ...
        for (let pageNumber = 1; pageNumber <= pdfDocument.numPages; pageNumber++) {
            ...
            this.highlightLayerRoots[pageNumber].render(React.createElement("div", null, (highlightsByPage[String(pageNumber)] || []).map((_a, index) => {
    ...
    render() {
        ...
        return (React.createElement("div", { onPointerDown: this.onMouseDown },
            React.createElement("div", { ref: this.attachRef, className: "PdfHighlighter", onContextMenu: (e) => e.preventDefault(), style: this.props.style },
